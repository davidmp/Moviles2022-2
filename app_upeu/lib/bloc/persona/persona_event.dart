...
class DeletePersonaEvent extends PersonaEvent{
  DeletePersonaEvent({@required PersonaModelo persona}):super(persona:persona);
}

class UpdatePersonaEvent extends PersonaEvent{
  UpdatePersonaEvent({@required PersonaModelo persona}):super(persona:persona);
}

class CreatePersonaEvent extends PersonaEvent{
  CreatePersonaEvent({@required PersonaModelo persona}):super(persona:persona);
}
